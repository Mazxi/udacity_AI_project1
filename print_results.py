...
def print_results(results_dic, results_stats_dic, model, 
    ...
    # the code block below prints summary statistics for the model that was ran

    for key in results_stats_dic:
        if key[0] == "p":
            print("{}: {}".format(key, results_stats_dic[key]))
    
    # The code below prints out images that are classified as dogs but are not dogs and the images classified as not dogs but they are dogs.                   
    ...
    # The code below prints out images that are classified as dogs but their breeds where misclassified.              
